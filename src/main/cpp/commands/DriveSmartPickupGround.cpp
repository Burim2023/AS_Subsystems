      ...
      m_elevator(elevator)
{
    ...
    // FIXED: Add safety check but don't return early - commands will check m_amcu before using it
    if (!m_amcu)
    {
        std::cout << "WARNING: AMCU is null in DriveSmartPickupGround constructor!" << std::endl;
        std::cout << "         This command will fail if scheduled. Call SetAMCU() before using." << std::endl;
    }
    ...
    AddCommands(
        ...
        frc2::InstantCommand([gripper]
            ...
            std::cout << "SmartPick: Opening gripper for apple detection" << std::endl; }, {gripper}),
        frc2::WaitCommand(2.0_s),
        ...
        frc2::ConditionalCommand(
            ...
            frc2::SequentialCommandGroup(
                ...
                frc2::InstantCommand([gripper]
                    ...
                    std::cout << "SmartPick: Closing gripper to grab apple" << std::endl; }, {gripper}),
                frc2::WaitCommand(2.0_s),
